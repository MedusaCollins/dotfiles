...
vim.keymap.set("n", "<C-BS>", "db", { desc = "Delete word backward in normal mode" })
...
vim.keymap.set("i", "<C-z>", "<C-o>u", { silent = true, expr = false, noremap = true, desc = "Undo in insert mode" })
...
vim.keymap.set("i", "<C-y>", "<C-r>", { silent = true, expr = false, noremap = true, desc = "Redo in insert mode" })

vim.keymap.set("n", "<C-y>", "<cmd>redo<CR>", { noremap = true, silent = true, desc = "Redo" })
vim.keymap.set(
  "n",
  "<C-o>",
...
vim.keymap.set("n", "<C-S-Right>", "vwe", { noremap = true, desc = "Select word to right with Ctrl+Shift+Right Arrow" })
vim.keymap.set("n", "<C-S-Left>", "bve", { noremap = true, desc = "Select word to left with Ctrl+Shift+Left Arrow" })
vim.keymap.set("n", "<C-S-Up>", "vek", { noremap = true, desc = "Select word to up with Ctrl+Shift+Up Arrow" })
vim.keymap.set("n", "<C-S-Down>", "vej", { noremap = true, desc = "Select word to down with Ctrl+Shift+Down Arrow" })
...
vim.keymap.set("i", "<C-S-Up>", "<Esc>vek", { noremap = true, desc = "Select word to up with Ctrl+Shift+Up Arrow" })
vim.keymap.set(
  "i",
  "<C-S-Down>",
  "<Esc>vej",
...
vim.keymap.set({ "n", "x" }, "<leader>p", '"0p', { desc = "Paste from register 0" })
...
vim.keymap.set("n", "<C-ö>", ':<C-u>call feedkeys("Vgc")<CR>', { noremap = true, silent = true })
vim.keymap.set("v", "<C-c>", '"+y', { silent = true, expr = false, noremap = true })

vim.keymap.set("i", "<C-c>", '<Esc>"+y`^a', { silent = true, expr = false, noremap = true })
...
-- })
vim.keymap.set("v", "<C-v>", '"+p', { silent = true, expr = false, noremap = true })
