...
vim.api.nvim_set_keymap("n", "d<S-Up>", "d{", { noremap = true, silent = true })
vim.api.nvim_set_keymap("n", "d<S-Down>", "d}", { noremap = true, silent = true })
...
vim.api.nvim_set_keymap("v", "d<S-Up>", "d{", { noremap = true, silent = true })
vim.api.nvim_set_keymap("v", "d<S-Down>", "d}", { noremap = true, silent = true })
